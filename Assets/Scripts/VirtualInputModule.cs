...
public class VirtualInputModule : PointerInputModule
{
    ...
    protected override MouseState GetMousePointerEventData(int id)
    {
        ...
        var click = Input.GetButtonDown("Interact1");

        m_MouseState.SetButtonState(PointerEventData.InputButton.Left, click ? PointerEventData.FramePressState.PressedAndReleased : StateForMouseButton(0), leftData);
